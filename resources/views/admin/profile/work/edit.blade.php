                        ...
                        <div class="panel-body">
                            {!! Form::open(['class' => 'md-form', 'enctype' => 'multipart/form-data', 'action' => ['ProfileController@work_update', $work->id], 'method' => 'POST']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" value="{{ $work->work_image }}" name="work_image" placeholder="Work Image" required="" class="form-control-file {{ $errors->has('work_image') ? ' is-invalid' : '' }}" id="imgInp">
